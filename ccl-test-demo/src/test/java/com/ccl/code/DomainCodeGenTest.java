...
import com.ccl.rain.codegen.SimpleMetaDataExporter;
import com.ccl.rain.codegen.serializer.*;
...
public class DomainCodeGenTest {
    private static final Logger logger = LoggerFactory.getLogger(DomainCodeGenTest.class);
